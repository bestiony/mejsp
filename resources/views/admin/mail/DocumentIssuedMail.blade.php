                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        <div style="text-align:right; padding:20px ;font-family: 'Cairo', sans-serif;">
                            ...
                            <a href="{{route('user_documents')}}" style="margin-top:10px;background-color: #09c; color: #fff; text-decoration: none; padding: 10px; border-radius: 4px; display: block; text-align: center;">تحميل المستند </a>
                               @php
                            ...
                            <div style=" margin-bottom:15px; font-family:'Cairo', sans-serif !important;">
                                <span style="float: right;color:#212121">ملف الدراسة</span>
                                <span style="float: left"><a target="_blank" href="{{$info['file']}}" download role="button">فتح البحث</a></span>
                                <div style="clear: both;"></div>
                            </div>
