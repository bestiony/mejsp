...
@section('content')
                    ...
                    <div class="col-sm-12  col-lg-7">
                        <div class="card" id="chat2">
                                            ...
                                            @if ($message->sender == 'admin')
                                                ...
                                                @elseif ($message->document !== null)
                                                    <div class="message sender file">
                                                        <a download href="{{ asset('email/' . $message->document . '') }}"> <i
                                                                class="fa-solid fa-folder-closed"></i></a>
                                                    </div>
                                                @endif
                            ...
                            <div class="card-footer text-muted d-flex justify-content-end align-items-center p-3">
                                ...
                                <textarea type="text" name="message" required minlength="2" class="form-control form-control-lg"
                                    id="exampleFormControlInput1" placeholder="ادخل الرسالة"></textarea>
                                {{-- upload file --}}
                                ...
                                margin: 0 2px;"></i>
                                {{-- submit message --}}
                                <button id="submit-msg-btn"><i class="fas fa-paper-plane"
    ...
    <script>
        ...
        channel.bind('research-chat-message', function(data) {
            ...
            let my_messages_type = sender_type == 'admin' ? 'sender' : 'recever'
            console.log(data);
            console.log(document_file);
            console.log(message);
            var push_html = ` <div class="message ${my_messages_type}">
                        ${message}
                    </div>`
            var push_ankerTag = ` <div class="message ${my_messages_type}">
                        <a href="${message}">
                        ${message}
                        </a>
                    </div>`
            var push_file_div = `<div class="message ${my_messages_type} file">
            ...
            document.querySelector("#chats").scrollTo(0, document.querySelector("#chats")
                .scrollHeight);
