                    ...
                    <div class="row">
                            ...
                            <div class="col-12 mb-4">
                                <div class="box-white pl-4">
                                    ...
                                    @if($research->invoice && $research->invoice->payment_response == 0)
                                    ...
                                    <div class="row my-3 px-5 facture-box">
                                        ...
                                        <div class="col-8">
                                            <form action="{{route('send_reminder')}}" method="POST" class="mb-1">
                                                @csrf
                                            <input type="hidden" name="research_id" value="{{$research->id}}">
                                            <select class="custom-select col-4-sm col-6" name="invoice-reminder" id="invoice-reminder">
                                                <option value="1">الرسالة 1 </option>
                                                <option value="2">الرسالة 2 </option>
                                                <option value="3">الرسالة 3 </option>
                                                <option value="4">الرسالة 4 </option>
                                                <option value="5">الرسالة 5 </option>
                                            </select>
                                        ...
                                        @elseif(session('reminder_fail'))
                                        <div class="alert  alert-danger alert-dismissible fade show" role="alert">
                                            {{session('reminder_fail')}}
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
