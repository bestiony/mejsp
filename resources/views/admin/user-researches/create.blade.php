                    ...
                    <div class="col-lg-12">
                        <div class="box-white p-3">
                            ...
                            <form class="form" id="form-create-users-researches"
                                action="{{ route('admin_store_research') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label class="required">إيمايل المستخدم</label>
                                    <div class="form-group col-12-sm ">

                                    <select data-width="100%"   name="user_id" class="selectpicker form-control search_select" data-live-search="true" required>
                                        <option  >اختر</option>
                                ...
                                <input  type="hidden" name="keywords_final"
                                    id="keywords_final">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    --}}
                                    <button id="submit_button" type="submit" class="btn-main btn-block"
                                        onclick="setKeywordsVal()" onmouseover="validateKeywords(event)">ارسال</button>
                                </div>
    ...
    $('#keywords-input').keydown(function(e) {
        if (e.keyCode === 13) {
            ...
            if(!onlyLettersAndNumbers(value)){
                toastr.error('الرجاء استعمال حروف وأرقام فقط في الكلمات المفتاحية');
                $(this).val('').focus()

                return ;
            }
            if(value.length && value != " " && value != "" && onlyLettersAndNumbers(value)){
                console.log('here');
                keywords.push(value);
...
function onlyLettersAndNumbers(str) {
    return true;
  return /^[a-zA-Z\u0600-\u06FF,-\s\d][\s\d\a-zA-Z\u0600-\u06FF,-]*$/.test(str);
}
