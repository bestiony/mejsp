                    ...
                    <div class="row">
                        ...
                        @else
                            <div class="col-12 mb-3">
                                <h5 class=" float-right">{{ $pageTitle }}</h5>
                                ...
                                <div class="box-white px-0 py-3">
                                    ...
                                    <div class="px-3">
                                        ...
                                        <span class=" float-left text-success font-weight-bold">$<span
                                                class="price">{{ $row->confCategory->price }}</span></span>
                            ...
                            <div class="col-lg-9 col-m d-8">
                                ...
                                <div class="box-white p-3">
                                    ...
                                    <form class="form" id="form-create-conference"
                                        action="{{ userUrl('conference/update') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="select-type-of-conferences" class="form-control" name="category"
                                                ...
                                                @foreach ($conferenceCategories as $cat)
                                                    <option @selected($row->category == $cat->id) value="{{ $cat->id }}">
                                                        {{ $cat->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('category')
                                        ...
                                        <div class="research-box">
                                            @if ($row->research_title != null)
                                                <div class="form-group"> <label>عنوان البحث <b
                                                            class="text-danger">*</b></label> <input type="text"
                                                        name="research_title" value="{{ $row->research_title }}" class="form-control" required=""> </div>
                                            @endif
                                        </div>
