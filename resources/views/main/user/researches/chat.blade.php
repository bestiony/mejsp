    ...
    <script>
        ...
        function showFileName() {
            ...
            research_label.innerHTML =
                '<span class="spinner-grow spinner-grow-sm ml-2" role="status" aria-hidden="true" style="    vertical-align: -0.325em;"></span>جاري الرفع ...'
            setTimeout(() => {
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="dropdown mb-3" id="actions-dropdown">
                                        ...
                                        <div class="dropdown-menu text-center m-0 bg-light w-100"
                                            style="    min-width: 180px;" aria-labelledby="triggerId">
                                            <a class="dropdown-item p-2 " href="{{ userUrl('researches') }}">تقديم دراسة
                                                جديدة </a>
                                            <hr class="my-0">
                                            <a class="dropdown-item p-2 delete-research" href="#">طلب حذف الدراسة</a>
                    ...
                    <div class="col-sm-12 col-md-5 col-lg-5">
                        ...
                        <div class="card" id="chat2">
                                        ...
                                        @if ($row->user_id == \Auth::guard('user')->user()->id)
                                            <div class="py-1 px-3">
                                                ...
                                                <div class="chat-item">
                                                    ...
                                                    @if ($row->file)
                                                        <a href="{{ $row->file }}" class="mb-1 small" target="_blank">
                                                            الملف المرفق</a>
                                                    @endif
                          ...
                          margin: 0 2px;"></i>
                            ...
                            <div id="file-error" class="alert alert-danger d-none" role="alert"></div>
                            <div class="card-footer p-3 d-none" id="file-box">
                                <div class="d-flex justify-content-between mx-3 mb-2 align-items-center"
                                    style="font-size: 13px;">
                                    <span>
                                        <span id="file-name" class="mx-2">ملف.ييخؤس</span>
                                        <span>حجم الملف : <strong id="file-size">25kb</strong></span>
                                    </span>
                                    <button id="remove-file" onclick="removeCurrentFile()" class="btn btn-danger btn-sm">
                                        X
                                        حذف
                                    </button>
                                </div>
                        ...
                        <div class="card min-side-cards d-none d-md-block" style="">
                            <div class="card-body">
                                    ...
                                    <div class="dropdown mb-3" id="actions-dropdown">
                                        ...
                                        <div class="dropdown-menu text-center m-0 bg-light w-100"
                                            ...
                                            <a class="dropdown-item p-2 " href="{{ userUrl('researches') }}">تقديم دراسة
                                                جديدة </a>
                                            <hr class="my-0">
                                            <a class="dropdown-item p-2 delete-research" href="#">طلب حذف
                                                الدراسة</a>
                                ...
                                <div class="row m-0 mb-2">
                                    ...
                                    <div class="col-8 text-muted pl-2">
                                        <a
                                            href="{{ route('current_user_researches', ['id' => $user_researches->id]) }}">{{ $user_researches->title }}</a>
                                    </div>
                                </div>
                                <div class="row m-0 mb-2">
                                    <div class="col-4 p-0 " style="line-height: 2">
                                    ...
                                    @foreach ($services as $service)
                                        <li class="media mt-3 mb-2 align-items-center">
                                            ...
                                            <div class="media-body ml-2">
                                                <a href="{{ $service->link }}"
                                                    class="mt-0 mb-1 font-weight-bold text-uppercase "
                                                    style="font-size: 0.9rem;">{{ $service->name }}</a>
                                    ...
                                    @foreach ($articles as $art)
                                        <li class="media mt-3 mb-1 mx-2">
                                            ...
                                            <div class="media-body">
                                                <a target="_blink" href="{{ url("article/$art->slug") }}"
                                                    class="mt-0 mb-1 font-weight-bold text-uppercase mr-3 "
                                                    style="font-size: 0.9rem;">{{ $art->title }}</a>
                                                {{-- <p style="font-size: 0.9rem">بعض الوصف حق الخدمة هنا يسبسيب سيبسيب</p> --}}
