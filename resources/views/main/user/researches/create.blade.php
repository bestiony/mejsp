                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="box-white p-3">
                                    ...
                                    <form class="form" id="form-create-users-researches" action="{{ userUrl('researches/store') }}"
                                        ...
                                        @if($study_submition_sections['title'] == 1)
                                        ...
                                        @endif
                                        @if($study_submition_sections['abstract'] == 1)
                                        ...
                                        @endif
                                        @if($study_submition_sections['type'] == 1)
                                        ...
                                        @endif
                                        @if($study_submition_sections['journal'] == 1)
                                        ...
                                        @endif
                                        @if($study_submition_sections['file'] == 1)
