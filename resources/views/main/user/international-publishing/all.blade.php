                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <a href="{{ userUrl('international-publishing/create') }}" class="btn-main float-left">طلب
                                جديد</a>
                        </div>
                                    ...
                                    <div class="box-white px-0">
                                        ...
                                        <div class="controls float-left pl-3">
                                            @if ($row->payment_response == 0)
                                                <a href="{{ userUrl('international-publishing/edit/' . $row->id) }}"
                                                    class="btn btn-outline-primary btn-sm"><i
                                                        class="fa-solid fa-pen"></i></a>
                                            @endif
                                            <form class="delete float-left" action="{{ userUrl('international-publishing/destroy') }}"
                                                method="POST">
                                        ...
                                        @if ($row->payment_response == 0)
                                            <div class="px-3 mt-3">
                                                <a href="{{ userUrl('international-publishing/checkout/' . $row->id) }}"
