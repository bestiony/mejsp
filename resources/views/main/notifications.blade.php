                        ...
                        <div class="box-white">
                            ...
                            <li style="background-color: #cee0d0;" class="p-2 rounded">
                             ...
                             @if($notification->data['type'] =="post" || $notification->data['type'] =="chat")
                                ...
                                @elseif($notification->data['type'] == 'email_confirmation' || $notification->data['type'] =="approve")
                                <a href="{{route('submit_new_study')}}" class="mr-4">
                                    تقديم دراسة للنشر
                                </a>
                                @elseif($notification->data['type'] == 'document' )
                                <a href="{{route('user_documents')}}" class="mr-4">
                                    الاطلاع على المستند
                                </a>
                                @else
