        ...
        <tr>
            ...
            <td align="center" width="600" bgcolor="#FFFFFF" style="border-radius: 5px">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        <div style="text-align:right; padding:20px ;font-family: 'Cairo', sans-serif;" dir="rtl">
                            <div style="text-align: center;"> <img src="{{ env('APP_URL') . env('APP_LOGO') }}"
                                    alt=""> </div>
                            <h2 style="color:#212121">مرحبا {{ $data['name'] }} </h2>
                             <h4>تم تأكيد بريدك الإلكتروني بنجاح يمكنك الآن الاستفادة من خدمات المنصة</h4>

                            <a href="{{ route('submit_new_study') }}"
                                style="text-decoration: none; background-color: #278cc2;color: #fff; padding: 10px 10px; display: block; text-align: center; border-radius: 3px;">تقديم دراسة للنشر</a>
                            <br>
