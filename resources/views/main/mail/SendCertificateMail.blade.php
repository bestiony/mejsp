                    ...
                    <tbody>
                        <div style="text-align:right; padding:20px ;font-family: 'Cairo', sans-serif;">
                            <div style="text-align: center;"> <img src="{{ env('APP_URL') . env('APP_LOGO') }}"
                                    alt=""> </div>
                            <h2 style="color:#212121">مرحباً {{ $info['username'] }}</h2>

                            <h5
                                style="font-weight: 200; color: #303030; margin-top: 15px;margin-bottom: 15px; font-size: 16px; text-align:right">
                                مبروك ! الان يمكنك تحميل الشهادة الخاصة بك من خلال الرابط التالي
                            </h5>

                            <a href="{{ $info['link'] }}"
                                style="text-decoration: none; background-color: #278cc2;color: #fff; padding: 10px 10px; display: block; text-align: center; border-radius: 3px;">تحميل الشهادة</a>
